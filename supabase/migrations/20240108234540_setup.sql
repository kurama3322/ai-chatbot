...
AS $$
DECLARE
  project_url TEXT := 'https://ptmjtpqjboozmghelfyv.supabase.co';
  service_role_key TEXT := 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InB0bWp0cHFqYm9vem1naGVsZnl2Iiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTcyMzIyMDU0NSwiZXhwIjoyMDM4Nzk2NTQ1fQ.ettST2ztCuc6U3rOrTcb2YGXKDHGaJBjIen-2cEk_tU'; -- full access needed for http request to storage
